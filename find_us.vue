	...
	<div id="find_us_container">
		...
		<div>
			<div class="row text-left">
					...
					<iframe title="Map" width="100%" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  :src="'http://maps.google.nl/maps?q='+full_address  +'&amp;hl=en&amp;ie=UTF8&amp;t=v&amp;hnear='+full_address  +'&amp;z=20&amp;output=embed'"></iframe>
