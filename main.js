...
require(['Vue', 'vuex', 'vue2-filters', 'vue_router', 'routes', 'datastore', 'vue-i18n', 'locales','jquery', 'moment', "vue-meta", "moment-timezone", "vue-moment",'vue-social-sharing','vue-select','vue-simple-spinner','vue!loader.vue', 'vue!social_links.vue', 'vue!header.vue', 'json!menu_items.json'], function (Vue, Vuex, Vue2Filters, VueRouter, appRoutes, store, VueI18n, messages, $, moment, Meta, tz, VueMoment, SocialSharing, VueSelect, Spinner, Loader, SocialLinks, Header, MenuItems) {
    Vue.use(Meta);
    Vue.use(VueRouter);
    Vue.use(Vue2Filters);
    Vue.use(VueI18n);
    ...
    const vm = new Vue({
        ...
        data: function() {
            return {
                dataLoaded: false,
                property_logo: "//codecloud.cdn.speedyrails.net/sites/5af0ca636e6f6450e96b0000/image/png/1522339630252/PCMlogogreen@2x.png",
        ...
        created() {
            this.loadData().then(response => {
                ...
                this.locale = "en-ca";
                this.property.default_logo_url = "//codecloud.cdn.speedyrails.net/sites/5af0ca636e6f6450e96b0000/image/png/1520614602000/PCM_Logo_InfoSheet_Feb2018 (1)-03.png";
            });
