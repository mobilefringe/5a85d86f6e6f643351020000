                    ...
                    <form id="walking_club" class="form-horizontal padding_top_20 js-cm-form" action="form-submit" v-on:submit.prevent="validateBeforeSubmit">
                        <div class="form-group ">
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('first_name')}">
								...
								<input v-model="form_data.first_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="first_name" type="text" placeholder="First Name" data-vv-delay="500" data-vv-as="guardian's first name" id="first_name">
							...
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('last_name')}">
								...
								<input v-model="form_data.last_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="last_name" type="text" placeholder="Last Name" data-vv-delay="500" data-vv-as="guardian's last name" id="last_name">
						...
						<div class="form-group">
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('email')}">
								...
								<input v-model="form_data.email" v-validate="'required|email'" class="form-control js-cm-email-input" :class="{'input': true}" name="cm-ziuddl-ziuddl" type="email" placeholder="Email" data-vv-delay="500" data-vv-as="email" id="email">
							...
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('phone')}" >
								...
								<input v-model="form_data.phone" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="cm-f-attkhk" type="text" placeholder="Phone number" data-vv-delay="500" data-vv-as="phone" id="phone">
							...
							<div class="col-sm-6 col-xs-12 " :class="{'has-error': errors.has('postal')}"  style="padding-top: 20px;">
								...
								<input v-model="form_data.postal_code" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="cm-f-attkkj" type="text" placeholder="Postal Code" data-vv-delay="500" data-vv-as="postal code" id="postal">
							...
							<div class="col-sm-6 col-xs-12 " :class="{'has-error': errors.has('age')}"  style="padding-top: 20px;">
								...
								<input v-model="form_data.age" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="cm-f-attkkt" type="text" placeholder="Age" data-vv-delay="500" data-vv-as="age" id="age">
								<span v-show="errors.has('age')" class="form-control-feedback">{{ errors.first('postal') }}</span>
							</div>
						...
						<div class="form-group">
						    <div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('doc_approval')}"  style="padding-top: 20px;">
                				...
                				<input class="form-control" id="doc_approval" type="hidden">
                				<fieldset><radio name="cm-f-attkkh" value="yes" v-model="form_data.doc_approval">Yes</radio>
                			...
                			<div class="col-sm-6 col-xs-12 " :class="{'has-error': errors.has('num_walks')}"  style="padding-top: 20px;">
								...
								<input v-model="form_data.num_walks" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="cm-f-attkkk" type="text" placeholder="Times Per Week" data-vv-delay="500" data-vv-as="Number of Walks" id="num_walks">
        ...
        return Vue.component("mall_walking_club", {
            ...
            created() {
                this.loadData().then(response => {
                    ...
                    var temp_repo = this.findRepoByName('Mall Walker Banner');
                    if(temp_repo) {
                ...
                validateBeforeSubmit() {
                    ...
                    this.$validator.validateAll().then((result) => {
                        ...
                        if(errors && errors.items.length == 0){
                            ...
                            contact_form["How many times per week do you plan to walk at the centre?"] = this.form_data.num_walks ;
