                    ...
                    <form id="strollers_n_boots" class="form-horizontal padding_top_20 js-cm-form" action="form-submit" v-on:submit.prevent="validateBeforeSubmit">
						...
						<div class="form-group">
							...
							<div class="col-sm-6 col-xs-12 " :class="{'has-error': errors.has('age')}"  style="padding-top: 20px;">
								...
								<input v-model="form_data.age" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="cm-f-atyjrk" type="text" placeholder="Age" data-vv-delay="500" data-vv-as="age">
								<span v-show="errors.has('postal')" class="form-control-feedback">{{ errors.first('postal') }}</span>
							</div>
                			...
                			<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('gender')}"  style="padding-top: 20px;">
                				<label class="label" for="gender">Have you checked with your physiciam priror ro walking at the centre? <span class="req_star"> *</span></label>
                				<radio name="gender_" value="male" v-model="form_data.gender">Yes</radio>
                                <radio name="gender" value="female" v-model="form_data.gender">No</radio>
                                <span v-if="genderError" class="form-control-feedback">Please choosed a gender</span>
                			</div>
						</div>
