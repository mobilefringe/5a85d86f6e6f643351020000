                    ...
                    <form class="form-horizontal js-cm-form" id="subForm" action="https://www.createsend.com/t/subscribeerror?description=" method="post" data-id="92D4C54F0FEC16E5ADC2B1904DE9ED1A2424A7FAF2895AE27BC1E6B945831C3A814668D6DF314C6CFD5AD436FBA4357E38F8203633B221924D53F47AEFF534B1" @submit.prevent="validateBeforeSubmit">
						...
						<div class="form-group ">
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('cm-f-qhdikk')}" >
								...
								<input v-model="form_data.birthday" class="form-control" v-validate="'required|date_format:DD/MM/YYYY'" :class="{'input': true}" name="cm-f-qhdikk" type="text" placeholder="dd/mm/yyyy" data-vv-delay="500" data-vv-as="birthday">
							...
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('cm-f-qhdikh')}">
								...
								<radio name="cm-f-qhdikh" value="male" v-model="form_data.gender">Male</radio>
                                <radio name="cm-f-qhdikh" value="female" v-model="form_data.gender">Female</radio>
						...
						<div class="form-group account-btn text-left m-t-10 agreement">
							...
							<div class="col-xs-12" style="margin-top: 20px;">
								<button class="contest_btn" type="submit" :disabled="formSuccess" @submit.prevent="validateBeforeSubmit">Submit</button>
							</div>
						</div>
					</form>
...
<script>
    define(["Vue", "vuex", "axios", "moment", "moment-timezone", "vue-moment", "vue-meta", 'vee-validate', "v-calendar", 'utility', 'vue-checkbox-radio', 'campaignMonitor'], function(Vue, Vuex,axios, moment, tz, VueMoment, Meta, VeeValidate, VCalendar, Utility, CheckboxRadio, campaignMonitor) {
        Vue.use(Meta);
        Vue.use(VeeValidate);
