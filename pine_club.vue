        ...
        <div class="site_container">
            ...
            <div class="row"> 
                <div class="col-sm-12 contest_contents">
                    ...
                    <form class="form-horizontal js-cm-form" id="subForm" v-on:submit.prevent="validateBeforeSubmit" action="https://mobilefringe.createsend.com/t/d/s/zlyluu/" method="post">
