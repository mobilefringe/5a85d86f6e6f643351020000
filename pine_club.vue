                    ...
                    <form class="form-horizontal js-cm-form" id="subForm" action="form-submit" v-on:submit.prevent="validateBeforeSubmit">
						<div class="form-group ">
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('first_name')}">
								...
								<input v-model="form_data.first_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="first_name" type="text" placeholder="First Name" data-vv-delay="500" data-vv-as="first name" required id="first_name">
							...
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('last_name')}">
								...
								<input v-model="form_data.last_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" name="last_name" type="text" placeholder="Last Name" data-vv-delay="500" data-vv-as="last name" required id="last_name">
						...
						<div class="form-group">
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('cm-zlyluu-zlyluu')}">
								<label class="label" for="newsletter_email">Email <span class="req_star"> *</span></label>
						...
						<div class="form-group ">
							<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('cm-f-qhdikk')}" >
								...
								<input v-model="form_data.birthday" class="form-control" v-validate="'required|date_format:DD/MM/YYYY'" :class="{'input': true}" name="cm-f-qhdikk" type="text" placeholder="dd/mm/yyyy" data-vv-delay="500" data-vv-as="birthday" required id="birthday">
