            ...
            <div class="row"> 
                <div class="col-sm-12 contest_contents">
                    <form class="form-horizontal padding_top_20 js-cm-form" v-on:submit.prevent="validateBeforeSubmit" id="kids_pine_club" method="post">
						...
						<div class="form-group">
    						<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('timeslot')}"  style="padding-top: 20px;" v-if="!campaign">
                				<label class="label" for="timeslot">Gender <span class="req_star"> *</span></label>
