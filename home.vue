                ...
                <div v-masonry-tile class="item" >
                    <div v-for="feature in feature_items" :class="'grid-item ' + feature.masonry_class ">
                    	...
                    	<!--class="ih-item circle effect19"-->
                    		<router-link :to="{ name: 'storeDetails', params: { category: feature.prop }}" v-if="feature.prop">
            ...
            methods: {
                loadData: async function() {
                    try {
                        ...
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData", "feature_items"), this.$store.dispatch("getData", "promotions"), this.$store.dispatch("getData", "popups"), this.$store.dispatch('LOAD_PAGE_DATA', {url: "http://pinecentre.mallmaverick.com/api/v2/pinecentre/social.json"})]);
                        return results;
                    } catch (e) {
