        ...
        <div class="site_container">
            ...
            <div class="row">
                <div class="col-sm-12" v-if="screenQuestions[0]">
                    ...
                    <radio name="cm-f-attkkh" value="yes" v-model="screenQuestions.doc_approval">Yes</radio>
                    <radio name="cm-f-attkkh" value="no" v-model="screenQuestions.doc_approval">No</radio>
                </div>
            </div> 
