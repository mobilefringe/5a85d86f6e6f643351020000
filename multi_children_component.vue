    ...
    <div> <!-- for some reason if you do not put an outer container div this component template will not render -->
       <div class="form-group " id="child_container">
			<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('child_first_name')}">
				<label class="label" :for="'child_first_name_'+ id_num">Child's First Name <span class="req_star"> *</span></label>
				<input v-model="child_form_data.child_first_name" v-validate="'required:true'" class="form-control" :class="{'input': true}" :name="'child_first_name_' + id_num" type="text" placeholder="First Name" data-vv-delay="500" data-vv-as="child's first name" :id="'child_first_name_' + id_num" required>
			...
			<div class="col-sm-6 col-xs-12" :class="{'has-error': errors.has('age')}" v-if="campaign">
				...
				<input v-model="child_form_data.age" v-validate="'required|integer'" class="form-control" :class="{'input': true}" :name="'age'+ id_num" type="text" placeholder="Age" data-vv-delay="500" data-vv-as="child's age" :id="'age'+ id_num" required>
...
<script>
    define(["Vue", 'vee-validate',  'vue-checkbox-radio', 'utility'], function(Vue,  VeeValidate, CheckboxRadio, Utility) {
        ...
        return Vue.component("multi-children-component", {
            ...
            watch : {
                child_form_data () {
                    this.child_form_data.id_num = this.id_num;
