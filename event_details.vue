			...
			<div class="row">
				<div class="col-sm-12 promo_image_container text-left">
					...
					<div class="row">
						...
						<social-sharing :url="shareURL(currentEvent.slug)" :title="currentEvent.title" :description="currentEvent.description" :quote="currentEvent.description_short" twitter-user="EastgateSquare" :media="currentEvent.image_url" inline-template >
    ...
    define(['Vue', 'vuex', 'moment', 'vue-lazy-load'], function(Vue, Vuex, moment, VueLazyload) {
        ...
        return Vue.component("event-details-component", {
            ...
            methods: {
                ...
                shareURL(slug){
                    var share_url = "https://pinecentre.com/event/" + slug;
                    return share_url;
                },
            }
        });
