			...
			<div class="row">
				<div class="col-sm-12 promo_image_container text-left">
					...
					<div class="row">
						...
						<social-sharing :url="shareURL(currentEvent.slug)" :title="currentEvent.title" :description="currentEvent.description" :quote="_.truncate(currentEvent.description, {'length': 99})" twitter-user="EastgateSquare" :media="currentEvent.image_url" inline-template >
